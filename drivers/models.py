...
class Driver(models.Model):
    ...
    direccion_base = models.TextField(null=True, blank=True, help_text="Dirección textual de la base/almacén/bodega")
    base_lat = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    base_lng = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    ...
    direccion_actual = models.TextField(null=True, blank=True, help_text="Dirección textual actual (geocoding inverso)")
